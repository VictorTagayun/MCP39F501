...
{
  char read_packet[8] = {0xA5, 0x08, 0x41, 0x00, 0x0, 0x4e, 0x78, 0xff};
  char checksum = 0x00;
...
#define read_packet_cntr 8
  ...
  char ack = 0x00;
  char select_and_read [] = {0xa5, 0x0a, 0x4c, 0x4c, 0x41, 0x00, 0x0, 0x4e, 0x78, 0xff}; // {0xa5, 0x0a, 0x4c, 0x4c, 0x41, 0x00, 0x0, 0x4e, 0x5e, 0xff};
...
void auto_measure()
{
  ...
  else if (packet_cntr < (0x78 + 3) ) // wrong packet number
  {
    msg_ok = false;
  ...
  else if (packet_cntr  ==  (0x78 + 3)) // correct packet number
  {
